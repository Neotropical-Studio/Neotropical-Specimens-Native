// ============================================================================
// ISO-3166 alpha-2 → ISO-4217 para ~240 países/territorios.
// Alimenta el checkout regenerativo (divisa local + PEN + USD).
// ============================================================================

/** Divisa principal de cobro/display por país. Default USD si no hay mapeo. */
export const COUNTRY_CURRENCY: Record<string, string> = {
  ...
  TC: 'USD', TD: 'XAF', TG: 'XOF', TH: 'THB', TJ: 'TJS', TK: 'NZD', TL: 'USD',
