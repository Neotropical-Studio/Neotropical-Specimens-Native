...
print("🚀 Sincronizando datos a Neon DB con control antiduplicados...\n")
...
print(f" ├─ Nuevos registros insertados: {insertados}")
print(f" └─ Duplicados omitidos / protegidos: {omitidos_duplicados}")
