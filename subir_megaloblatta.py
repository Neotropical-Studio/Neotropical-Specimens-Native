...
especies = [
    ("Blaberidae", "Megaloblatta longipennis", "Megaloblatta", "longipennis")
]

print(f"🔄 Registrando {len(especies)} especie bajo Blaberidae...")
...
print("\n✨ ¡Proceso completado! Recarga tu catálogo para verla en la sección Blaberidae.")
