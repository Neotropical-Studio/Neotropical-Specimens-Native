...
# Lista de Orthoptera
especies = [
    ("Orthoptera", "Tropidacris dux", "Tropidacris", "dux"),
    ("Orthoptera", "Titanacris picticrus picticrus", "Titanacris", "picticrus picticrus"),
    ("Orthoptera", "Titanacris albipes", "Titanacris", "albipes"),
    ("Orthoptera", "Lophacris cristata", "Lophacris", "cristata")
]
...
print("\n✨ ¡Proceso completado! Recarga tu navegador para verlos en el catálogo.")
